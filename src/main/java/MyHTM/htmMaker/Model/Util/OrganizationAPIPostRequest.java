...
public class OrganizationAPIPostRequest {
    ...
    public OrganizationAPIPostRequest(String organization_name, String superuser_name, String superuser_lastname, String superuser_email, String superuser_password) {
